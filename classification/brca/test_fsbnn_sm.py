...
# Apply FSBNN-ws on BRCA dataset
import torch
...
import time
import sys
sys.path.insert(0, '/home/akanksha19231201/projects/wsbnn-sbnn/classification')
...
curr_dir = "/home/akanksha19231201/projects/wsbnn-sbnn/classification/cancer-data-1"
...
#     print('features selected in the first layer: {}'.format(indices[0:10]))
#     print('features selected in the first layer: {}'.format([genes[i] for i in indices[0:10]]))
...
# plt.tight_layout()
# plt.savefig(f"{curr_dir}/{code}/ws_train_loss_run10")
# plt.show()
...
# plt.legend()
# plt.tight_layout()
# plt.savefig(f"{curr_dir}/{code}/ws_train_test_accuracy_run10")
# plt.show()
...
# plt.savefig(f"{curr_dir}/{code}/ws_cm_train_run10")
# plt.show()
...
# plt.savefig(f"{curr_dir}/{code}/ws_cm_test_run10")
# plt.show()
