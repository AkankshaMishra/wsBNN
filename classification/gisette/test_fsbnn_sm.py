...
# Apply FSBNN-ws on Gisette data
import torch
...
# curr_dir = "/Users/Akanksha Mishra/Documents/GitHub/sbnn/classification/dataset-stg-4"
# code = "fsbnn_samplemean"
# #------------------------------------------------------------------------------------------------------
# # Create a simple dataset
# mat = scipy.io.loadmat(f'{curr_dir}/gisette.mat')
...
#     print('features selected in the first layer: {}'.format(indices[0:10]))
#     torch.save(sorted, f"{curr_dir}/{code}/ws_sorted_run3.pt")
#     torch.save(indices, f"{curr_dir}/{code}/ws_fsbnn_indices_run3.pt")
#     np.save(f"{curr_dir}/{code}/ws_fsbnn_run3",indices)
