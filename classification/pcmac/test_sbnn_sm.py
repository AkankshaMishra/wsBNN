...
for k in range(1, 2):
    ...
    train_precision = precision_score(y_train.cpu().numpy(), pred.cpu().numpy(), average='weighted', zero_division=0)
    train_recall = recall_score(y_train.cpu().numpy(), pred.cpu().numpy(), average='weighted', zero_division=0)
    train_f1 = f1_score(y_train.cpu().numpy(), pred.cpu().numpy(), average='weighted', zero_division=0)
    ...
    test_precision = precision_score(y_test.cpu().numpy(), pred2.cpu().numpy(), average='weighted', zero_division=0)
    test_recall = recall_score(y_test.cpu().numpy(), pred2.cpu().numpy(), average='weighted', zero_division=0)
    test_f1 = f1_score(y_test.cpu().numpy(), pred2.cpu().numpy(), average='weighted', zero_division=0)
