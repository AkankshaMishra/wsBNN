...
trainsets = []
x_data, y_data = make_friedman1(n_samples = data_size, n_features = data_dim)
...
for k in range(10, 11):
    ...
    sorted, indices = torch.sort(p, 0, descending=True) #write one1_w instead of p for weight sharing
